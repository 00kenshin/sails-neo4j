...
var adapter = module.exports = (function() {
  ...
  return {
    ...
    update: function(connectionName, collectionName, params, values, cb) {
    ...
    destroy: function(connectionName, collectionName, params, cb) {
      var q, delimiter = '';
    ...
    link: function(connectionName,collectionName, predecessorParams, successorCollectionName, successorParams, relationshipType, relationshipParams, cb) {
